                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            function displayProducts() {
                                ...
                                products.forEach((product) => {
                                    ...
                                    <td><img src="${product.image}" alt="Imagen del producto" width="80"></td>
                                    <td>
                            ...
                            productForm.addEventListener("submit", (e) => {
                                ...
                                if (editing) {
                                    const productIndex = products.findIndex((p) => p.id === currentId);
                                    if (productIndex !== -1) {
                                        products[productIndex] = {
                                            ...
                                            price,
                                            description,
                                            image: products[productIndex].image // Keep the existing image if not updated
                                        };
                                    }
                                } else {
                                    ...
                                    products.push({
                                        ...
                                        price,
                                        description,
                                        image: image ? URL.createObjectURL(image) : "" // Store image URL if provided
                                    });
                                }
