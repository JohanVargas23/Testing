                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            const providers = [{
                                ...
                                phone: "123-456-7890",
                                address: "Calle Ejemplo 1, Ciudad Ejemplo"
                            }, {
                                id: 2,
                                name: "Proveedor Ejemplo 2",
                                email: "proveedor2@example.com",
                                phone: "987-654-3210",
                                address: "Calle Ejemplo 2, Ciudad Ejemplo"
                            }];
                            ...
                            function displayProviders() {
                                ...
                                editBtns.forEach((btn) => {
                                    btn.addEventListener("click", (e) => {
                                        ...
                                        const providerToEdit = providers.find((provider) => provider.id === parseInt(id));
                                        if (providerToEdit) {
                                            editing = true;
                                            currentId = providerToEdit.id;
                                            document.getElementById("providerId").value = providerToEdit.id;
                                            document.getElementById("name").value = providerToEdit.name;
                                            document.getElementById("email").value = providerToEdit.email;
                                            document.getElementById("phone").value = providerToEdit.phone;
                                            document.getElementById("address").value = providerToEdit.address;
                                ...
                                deleteBtns.forEach((btn) => {
                                    btn.addEventListener("click", (e) => {
                                        const id = e.target.getAttribute("data-id");
                                        const providerIndex = providers.findIndex((provider) => provider.id === parseInt(id));
                                        if (providerIndex !== -1) {
                            ...
                            providerForm.addEventListener("submit", (e) => {
                                ...
                                if (editing) {
                                    const providerIndex = providers.findIndex((p) => p.id === currentId);
                                    if (providerIndex !== -1) {
